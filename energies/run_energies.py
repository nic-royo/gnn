...
def main(args):
    ...
    filename = f'results/seed/oversmooth_adj_{args.model_type}_layers_{args.num_hops}_{args.dataset}.csv'
    ...
    filename = f'results/seed/oversmooth_old_{args.model_type}_layers_{args.num_hops}_{args.dataset}.csv'
    ...
    filename = f'results/seed/oversmooth_roth_{args.model_type}_layers_{args.num_hops}_{args.dataset}.csv'
