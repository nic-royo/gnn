...
def main(args):
    ...
    os.makedirs('results/no_linear', exist_ok=True)
    ...
    filename = f'results/no_linear/oversmooth_adj_{args.model_type}_layers_{args.num_hops}_{args.dataset}.csv'
    ...
    filename = f'results/no_linear/oversmooth_old_{args.model_type}_layers_{args.num_hops}_{args.dataset}.csv'
    ...
    filename = f'results/no_linear/oversmooth_roth_{args.model_type}_layers_{args.num_hops}_{args.dataset}.csv'
